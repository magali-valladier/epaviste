...
function CalendarServerSideRender(props)
{
    ServerSideRender.call(this, props);
}

CalendarServerSideRender.prototype = Object.create(ServerSideRender.prototype);
CalendarServerSideRender.prototype.constructor = CalendarServerSideRender;

CalendarServerSideRender.prototype.componentDidUpdate = function (prevProps, prevState) {
    ServerSideRender.prototype.componentDidUpdate.call(this, prevProps, prevState);

    if (this.state.response !== prevState.response) {
        jQuery('.mphb-calendar.mphb-datepick:not(.is-datepick)').each(function (_, element) {
            new MPHB.RoomTypeCalendar(jQuery(element));
        });
    }
};

function SliderServerSideRender(props)
{
    ServerSideRender.call(this, props);
}

SliderServerSideRender.prototype = Object.create(ServerSideRender.prototype);
SliderServerSideRender.prototype.constructor = SliderServerSideRender;

SliderServerSideRender.prototype.componentDidUpdate = function (prevProps, prevState) {
    ServerSideRender.prototype.componentDidUpdate.call(this, prevProps, prevState);
