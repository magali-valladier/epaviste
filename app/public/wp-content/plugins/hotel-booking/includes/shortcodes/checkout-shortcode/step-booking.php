...
class StepBooking extends Step {
	...
	protected function parseBookingData(){
		...
		$bookingDetails		 = apply_filters('mphb_sc_checkout_step_booking_rooms_details', $_POST['mphb_room_details']);
	...
	protected function parseCustomerData(){
        ...
        $customerData = apply_filters('mphb_sc_checkout_step_booking_customer_details', $customerData);
