...
function woods_main_menu() {
	...
	<nav id="site-navigation" class="<?php echo join( ' ', $classes ); ?>" role="navigation">
		...
		<?php
			$args = apply_filters( 'woods-theme/menu/main-menu-args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
...
function woods_footer_menu() { ?>
	...
	<?php
		$args = apply_filters( 'woods-theme/menu/footer-menu-args', array(
...
function woods_get_social_list( $context, $type = 'icon' ) {
	...
	$args = apply_filters( 'woods-theme/social/list-args', array(
