...
if ( ! class_exists( 'Woods_Woo_Module' ) ) {

	/**
	 * Define Woods_Woo_Module class
	 */
	class Woods_Woo_Module extends Woods_Module_Base {
		...
		public function filters() {
			...
			add_filter( 'woods-theme/assets-depends/script', array( $this, 'assets_depends_script' ) );

			add_filter( 'woods-theme/customizer/options', array( $this, 'customizer_options' ) );

			add_filter( 'cx_customizer/core_sections', array(  $this, 'woods_customizer_core_sections' ) );
		}

		/**
		 * Add WooCommerce customizer sections
		*/
		public function woods_customizer_core_sections( $sections ) {
		...
		public function customizer_options( $options ) {
			...
			$new_options = array(
				'woocommerce_accent_color' => array(
					'title'    => esc_html__( 'WooCommerce Accent color', 'woods' ),
		...
		public function assets_depends_script( $scripts_depends ) {
			array_push( $scripts_depends, 'woods-woo-module-script' );
