...
if ( ! class_exists( 'Woods_Woo_Breadcrumbs_Module' ) ) {

	/**
	 * Define Woods_Woo_Breadcrumbs_Module class
	 */
	class Woods_Woo_Breadcrumbs_Module extends Woods_Module_Base {
		...
		public function get_wc_breadcrumbs( $is_custom_breadcrumbs, $args ) {
			...
			$wc_breadcrumbs = new Woods_WC_Breadcrumbs( $args );
