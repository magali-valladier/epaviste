...
if ( ! class_exists( 'Woods_Blog_Layouts_Module' ) ) {

	/**
	 * Define Woods_Blog_Layouts_Module class
	 */
	class Woods_Blog_Layouts_Module extends Woods_Module_Base {
		/**
		 * properties.
		 */
		private $layout_type;
		...
		public function filters() {
			...
			add_filter( 'woods-theme/customizer/options', array( $this, 'customizer_options' ) );
			add_filter( 'woods-theme/customizer/blog-sidebar-enabled', array( $this, 'customizer_blog_sidebar_enabled' ) );
			add_filter( 'woods-theme/posts/template-part-slug', array( $this, 'apply_layout_template' ) );
			add_filter( 'woods-theme/posts/post-style', array( $this, 'apply_style_template' ) );
			add_filter( 'woods-theme/posts/list-class', array( $this, 'add_list_class' ) );
			add_filter( 'woods-theme/site-content/container-enabled', array( $this, 'disable_site_content_container' ) );
		...
		public function module_init_properties() {
			...
			$this->layout_type  = woods_theme()->customizer->get_value( 'blog_layout_type' );
			$this->layout_style = woods_theme()->customizer->get_value( 'blog_style' );
			...
			$new_options = array(
				'blog_layout_type' => array(
					...
					'choices'  => array(
						...
						'grid'             => esc_html__( 'Grid', 'woods' ),
						'masonry'          => esc_html__( 'Masonry', 'woods' ),
						'vertical-justify' => esc_html__( 'Vertical Justify', 'woods' ),
						'creative'         => esc_html__( 'Creative', 'woods' ),
					),
					'type' => 'control',
				),
				'blog_style' => array(
					'title'    => esc_html__( 'Style', 'woods' ),
					'section'  => 'blog',
					'priority' => 2,
					'default'  => 'default',
					'field'    => 'select',
					'choices'  => array(
						...
						'v2'      => esc_html__( 'Style 2', 'woods' ),
						'v3'      => esc_html__( 'Style 3', 'woods' ),
						'v4'      => esc_html__( 'Style 4', 'woods' ),
						'v5'      => esc_html__( 'Style 5', 'woods' ),
						'v6'      => esc_html__( 'Style 6', 'woods' ),
						'v7'      => esc_html__( 'Style 7', 'woods' ),
						'v8'      => esc_html__( 'Style 8', 'woods' ),
						'v9'      => esc_html__( 'Style 9', 'woods' ),
						'v10'     => esc_html__( 'Style 10', 'woods' ),
					),
					'type' => 'control',
				),
			);
