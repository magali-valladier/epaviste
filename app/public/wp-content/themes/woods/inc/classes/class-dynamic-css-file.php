...
if ( ! class_exists( 'Woods_Dynamic_CSS_File' ) ) {

	/**
	 * Define Woods_Dynamic_CSS_File class
	 */
	class Woods_Dynamic_CSS_File {
		...
		public function is_cache_dynamic_css() {
			...
			$cache_dynamic_css   = woods_settings()->get( 'cache_dynamic_css', 'false' );
		...
		public function maybe_create_css_file() {
			...
			$css = woods_theme()->dynamic_css->get_inline_css();
		...
		public function remove_print_inline_style() {
			...
			remove_action( 'wp_enqueue_scripts', array( woods_theme()->dynamic_css, 'add_inline_css' ), 99 );
		}
		...
		public function dynamic_url() {
			...
			$this->dynamic_url = trailingslashit( $upload_base_dir ) . 'woods/';
		...
		public function dynamic_dir() {
			...
			$this->dynamic_dir = trailingslashit( $upload_base_dir ) . 'woods/';
...
if ( ! function_exists( 'woods_dynamic_css_file' ) ) {

	/**
	 * Returns instance of Woods_Dynamic_CSS_File
	 *
	 * @since  1.0.0
	 * @return Woods_Dynamic_CSS_File
	 */
	function woods_dynamic_css_file() {
		return Woods_Dynamic_CSS_File::get_instance();
	}
}

woods_dynamic_css_file();
