...
if ( ! class_exists( 'Woods_Widget_Area' ) ) {

	class Woods_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'woods-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'woods-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'woods-theme/widget_area/classes', $classes, $area_id );
	...
	function woods_widget_area() {
		return Woods_Widget_Area::get_instance();
	}
