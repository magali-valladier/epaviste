<?php
/**
 * Template Name: Post Layout 08
 * Template Post Type: post
 *
 * The template for displaying layout 8 single posts.
 *
...
get_header(); 
	?><div class="site-content__wrap"><?php
		get_template_part( 'template-parts/single-post/headers/header-v8', get_post_format() );
		?><div class="container">
			<div class="row">
