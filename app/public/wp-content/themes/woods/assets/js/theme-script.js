// Responsive menu
var woodsResponsiveMenu = function woodsResponsiveMenu() {
...
(function($) {
	...
	Woods_Theme_JS = {
		...
		toTopInit: function() {
			if ( undefined === window.woodsConfig.toTop || ! window.woodsConfig.toTop ) {
				return;
			}
		...
		toTop: function( options ) {
			...
			$( buttonSelector ).hide().on( 'click.WoodsThemeToTop', function() {
		...
		responsiveMenuInit: function() {
			if (typeof woodsResponsiveMenu !== 'undefined') {
				woodsResponsiveMenu();
			}
		},
